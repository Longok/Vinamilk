            ...
            @foreach(Session::get('cart') as $key => $val) 
                ...
                <tr class="cart-content">
                    ...
                    <td class="cart-quantity">
                        <div class="cart-quantity-button">
                            <form action="{{URL::to('/update-cart')}}" method="post">
                                ...
                                <!-- <input type="hidden" value="" name="cart_quantity[{{$val['id']}}]"> -->
                    ...
                    <td class="cart_delete">
                        <a class="cart-quantity-delete" href="{{ URL::to('/delete-cart-ajax/'.$val['id'])}}"><i
    ...
    <div class="col-md-4 col-xs-4 mx-auto float-left mb-5 mt-5">        
        <div class="">
            <ul>
                ...
                <li><a href="" class="breadcrumb">Tổng tiền:{{number_format($total,0,',','.')}} đ</a></li>
            </ul>
