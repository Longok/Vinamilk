            ...
            @foreach($products as $pro)
                <div class="box col-lg-4 col-md-4 col-sm-6 col-xs-6 mt-2">
                    <!-- <form action="{{Route('cart',$pro->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="quantity">
                                ...
                                <button type="button" class="btn btn-primary mb-2 add-cart-ajax" data-id_product="{{$pro->id}}">Mua hàng</button>
                            </div>
                        </div>
                    </form> -->
                    <!-- add cart ajax -->
                    ...
                    @csrf
                        ...
                        <!-- <input type="hidden" value="1" class="product_quantity_{{ $pro->id }}">              -->
                        <div class="card">
                            <div class="card-image d-flex justify-content-around mt-2">
                                <img src="{{ asset('/storage/image/'.$pro->image) }}" height="160">
                            </div>
