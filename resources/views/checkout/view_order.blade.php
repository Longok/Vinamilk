            ...
            @foreach( $order_detail as $key => $detail)
                ...
                @endphp          
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('storage/image/'.$detail->product->image) }}" height="100" width="100">
                        </td>
                        <td>
                            <input id="quantity" type="number" min="1" value="{{$detail->product_quantity}}" name="product_quantity" size="2">
                            <input type="hidden" value="{{$detail->product_id}}" name="order_product_id" class="order_product_id">
                            <input type="submit" class="btn" name="update_quantity" value="Thay đổi"></input>
                        </td>
